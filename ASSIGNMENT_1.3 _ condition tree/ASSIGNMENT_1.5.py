...
class EquallSigmaDiagonalMatrics(Method_Mean_Var_Covar_Calc):
    ...
    def Equll_sigma_Diagonal_Classifier(self):
        ...
        if(self.dataset==1):
            ...
            #d1=-y1+(-1*(b0+b1*x+d0)+((b0*x+b1*x+d0)**2-4*a1*(a0*x*x+c0*x +k0))**1/2)/(2*a1)
            #d2=-y1+(-1*(b0+b1*x+d0)-((b0*x+b1*x+d0)**2-4*a1*(a0*x*x+c0*x +k0))**1/2)/(2*a1)
            d#0=d1*d2
            i=0
            if(i==0):
                A1=[[],[]]
                ...
                while(1):
                    ...
                    while(1):
                        ...
                        d1=(-y+(-1*(b0+b1*x+d0)+((b0*x+b1*x+d0)**2-4*a1*(a0*x*x+c0*x +k0))**1/2)/(2*a1))/10000000000000
                        d2=(-y+(-1*(b0+b1*x+d0)-((b0*x+b1*x+d0)**2-4*a1*(a0*x*x+c0*x +k0))**1/2)/(2*a1))/10000000000000
                        d0=d1*d2
        ...
        # that is for third dataset
            ...
            if (k==1):
                ...
                plt.scatter(A1[0],A1[1],s=2)
                plt.scatter(B1[0],B1[1],s=2)
                plt.scatter(self.x_class1,self.y_class1,color='red',marker='*',s=5,label=l0  )
                plt.scatter(self.x1_class2,self.y1_class2,color='green',marker='*',s=5,label=l1  )
                ...
                while(1):
                    ...
                    while(1):
                        ...
                        d1=(-y+(-1*(b0+b1*x+d0)+((b0*x+b1*x+d0)**2-4*a1*(a0*x*x+c0*x +k0))**1/2)/(2*a1))/1000000
                        d2=(-y+(-1*(b0+b1*x+d0)-((b0*x+b1*x+d0)**2-4*a1*(a0*x*x+c0*x +k0))**1/2)/(2*a1))/1000000
                        d0=d1*d2
