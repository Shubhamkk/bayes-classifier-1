    ...
    def Equll_sigma_Diagonal_Classifier(self):
        ...
        if(self.dataset==1):
            ...
            if(k==1):
                ...
                l0='class2'
                l1='class3'
                Title='Fig_2 graph between class2 and class3 in dataset 2'
                cl='green'
                cl2='blue'
                ...
                l0='class3'
                l1='class1'
                Title='Fig_3 graph between class3 and class1 in dataset 2'
                cl='blue'
                cl2='red'
            ...
            while(1):
                ...
                while(1):
                    ...
                    a[0]=r_x
                    a[1]=r_y
                    d1=(-1/2)*nm.dot([ (a[0]-M_class1[0]),(a[1]-M_class1[1])],[ (a[0]-M_class1[0]),(a[1]-M_class1[1])])
                    d2=(-1/2)*nm.dot([ (a[0]-M_class2[0]),(a[1]-M_class2[1])],[ (a[0]-M_class2[0]),(a[1]-M_class2[1])])
            ...
            plt.scatter(A[0],A[1],color='yellow' ,s=1)
            plt.scatter(B[0],B[1],color='pink',s=1)
