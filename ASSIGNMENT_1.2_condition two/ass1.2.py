...
class EquallSigmaDiagonalMatrics(Method_Mean_Var_Covar_Calc):
    ...
    def Equll_sigma_Diagonal_Classifier(self):
        ...
        if(self.dataset==1):
            ...
            sigm_matrics1=[[m_00,m_01],[m_10,m_11]]

            Average_matrics=[[(m00+m_00)/2,(m01+m_01)/2],[(m10+m_10)/2,(m11+m_11)/2]]


            
            #calling inverse function to comput sigma inverse
            sigma_inverse=self.Matrix_inv( Average_matrics )
            A=sigma_inverse
            print('sigma inverse:',A)
            ...
            a0=M_class1[0]-M_class2[0]
            a1=M_class1[1]-M_class2[1] 
            a2=M_class1[0]*( A[0][0]*M_class1[0] + A[0][1]*M_class1[1])  +  M_class1[1]*( A[1][0]*M_class1[0] + A[1][1]*M_class1[1])
            a3=M_class2[0]*( A[0][0]*M_class2[0] + A[0][1]*M_class2[1])  +  M_class2[1]*( A[1][0]*M_class2[0] + A[1][1]*M_class2[1])
            a23=-1/2*(-a2+a3)
            ...
            #y=-(a0*A[0][0] + a1*A[1][0])*x/(a0*A[0][1] + a1*A[1][1])  + a23/(a0*A[0][1] + a1*A[1][1])
            ...
            if(i==0):
                ...
                while(1):
                    ...
                    while(1):
                        ...
                        d=-r_y-(a0*A[0][0] + a1*A[1][0])*r_x/(a0*A[0][1] + a1*A[1][1])  + a23/(a0*A[0][1] + a1*A[1][1])
                        #print(r_y)
                        if(d>0):
                            A1[0].append(r_x)
                            A1[1].append(r_y)
        ...
        # that is for third dataset
            ...
            if (k==1):
                ...
                r_x=-5
                r_y=-2
                r_y=-(a0*A[0][0] + a1*A[1][0])*r_x/(a0*A[0][1] + a1*A[1][1])  + a23/(a0*A[0][1] + a1*A[1][1])
                print('avi',r_y)
                '''
                A1=[[],[]]
                B1=[[],[]]
