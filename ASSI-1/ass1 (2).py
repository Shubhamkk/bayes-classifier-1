        ...
        def con_bou_conf(self):
            ...
            if(case==1):
                ...
                for k in range(3):
                    ...
                    a1=nm.arange((u_0-100),(u_0 +100),10)
                    a2=nm.arange((u_1-100),(u_1 +100),10)
                ...
                for test in range(3):
                    ...
                    while(1):
                        ...
                        sum1=0
                        sum1= -1/2*(nm.dot([(a[0]-self.mean[0][0]),(a[1]-self.mean[0][1])],
                                           nm.dot(self.sigma[0],[(a[0]-self.mean[0][0]),(a[1]-self.mean[0][1])])))-math.log(
                                               2*3.14*nm.sqrt(D1))
                                                   
                        
                        sum2=0
                        sum2= -1/2*(nm.dot([(a[0]-self.mean[1][0]),(a[1]-self.mean[1][1])],
                                           nm.dot(self.sigma[1],[(a[0]-self.mean[1][0]),(a[1]-self.mean[1][1])])))-math.log(
                                               2*3.14*nm.sqrt(D2))


                        sum3=0
                        sum3= -1/2*(nm.dot([(a[0]-self.mean[2][0]),(a[1]-self.mean[2][1])],
                                           nm.dot(self.sigma[2],[(a[0]-self.mean[2][0]),(a[1]-self.mean[2][1])])))-math.log(
                                               2*3.14*nm.sqrt(D3))
